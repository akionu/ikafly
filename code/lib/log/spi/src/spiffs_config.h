...
extern bool flashMutex_lock();
extern bool flashMutex_unlock();

#ifndef SPIFFS_LOCK
#define SPIFFS_LOCK(fs) flashMutex_lock();
#endif
// define this to exit a mutex if you're running on a multithreaded system
#ifndef SPIFFS_UNLOCK
#define SPIFFS_UNLOCK(fs) flashMutex_unlock();
#endif
...
#define SPIFFS_CFG_PHYS_ADDR(ignore)      (0x200000)
#endif
